...
1.**Total Revenue** : Measures the total revenue generated across all product categories during the analysis period.
Dashboard Value: £19.95 Million

2.**Total Units Sold** : Displays the total quantity of products sold.
Dashboard Value: 3.8 Million Units

3.**Total Transactions** : Represents the total number of completed customer transactions.
Dashboard Value: 190.8 Thousand Transactions

4.**Average Unit Price** : Calculates the average selling price of products.
Dashboard Value: £5.3
...
1.**Revenue by Category** : This visualization compares total revenue generated by each product category.
The dashboard indicates that Yogurt generates the highest revenue, followed by Milk, Ready Meal, Snack Bar, and Juice.

2.**Revenue by Brand** : The dashboard ranks brands based on total revenue, helping managers identify the strongest-performing brands and those with improvement opportunities.

3.**Revenue by Sales Channel** : Revenue is compared across three business channels:
**Retail** :
E-commerce
Discount
...
4.**Revenue Trend Over Time** : A time-series visualization tracks monthly revenue between 2022 and 2024, allowing users to identify:
